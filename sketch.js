...
function setup()
{
  ...
  // creating road
  road = createSprite(225, 225, 450, 450);
  road.addImage("road", roadImg);
  road.velocityY = 5;
  
  // creating boy
  boy = createSprite(225, 350, 20, 50);
  boy.addAnimation("running", boyRunning);
  boy.scale = 0.070;
  
  // creating game over animation
  gameOver = createSprite(225, 225, 20, 20);
...
function draw()
{
 ...
 if(gameState === PLAY)
 {
  ...
  textSize(15);
  fill("red");
  text("Treasure Collection: " + treasureCollection, 150, 30);
...
{
  // spawning swords
  sword = createSprite(random(20, 450), random(20, 200), 20, 20);
  sword.velocityY = 5;
...
{
  // spawning cash
  cash = createSprite(random(20, 450), random(20, 200), 20, 20);
  cash.velocityY = 5;
...
{
  // spawning jwell
  jwell = createSprite(random(20, 450), random(20, 200), 20, 20);
  jwell.velocityY = 5;
...
{
  // spawning diamonds
  diamond = createSprite(random(20, 450), random(20, 200), 20, 20);
  diamond.velocityY = 5;
...
{
  // spawning ruby
  ruby = createSprite(random(20, 450), random(20, 200), 20, 20);
  ruby.velocityY = 5;
